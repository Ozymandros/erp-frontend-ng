...
import { WarehouseDto, PaginatedResponse } from '../types/api.types';
...
describe('WarehousesService', () => {
  ...
  it('should fetch warehouses list', (done) => {
    const mockData: PaginatedResponse<WarehouseDto> = {
      items: [{ id: '1', name: 'WH1' } as unknown as WarehouseDto],
      total: 1,
      page: 1,
      pageSize: 10,
      totalPages: 1,
